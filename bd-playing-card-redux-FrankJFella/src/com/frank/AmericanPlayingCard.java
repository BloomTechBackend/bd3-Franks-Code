...
public class AmericanPlayingCard extends PlayingCard{
	...
	// We need to call the method to initialize the static Maps outside the constructor
	//    because the static data may exist before any objects are instantiated
	//    which means if the static data is references before the first object is instantiated
	//    the data will be uninitialized we called the method in a constructor
	//    Constructors are called when an object instantiated
	...
	// subclass ctor must call the super class ctor before it does anything else
