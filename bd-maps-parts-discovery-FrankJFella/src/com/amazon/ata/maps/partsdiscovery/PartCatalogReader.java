 ...
 * Reads teh text file that represents the catalog and separates into words
 */
public class PartCatalogReader {
    ...
    public static List<String> getCatalogWords(PartManufacturer company, int year, int month) {
        try {
            ...
            // get the current user directory and display
            // maybe in case the catalog file is not found so w2e know what directory we are using
