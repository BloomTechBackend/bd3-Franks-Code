...
public class ResponseData {
        ...
        private String creationTimeStamp; // variable names must match the json attribute names
        private String fullName;          // variable names must match the json attribute names
        private String dob;               // variable names must match the json attribute names
