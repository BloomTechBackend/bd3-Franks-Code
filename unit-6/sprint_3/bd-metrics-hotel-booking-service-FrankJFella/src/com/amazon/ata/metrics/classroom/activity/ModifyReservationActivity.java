...
public class ModifyReservationActivity {
    ...
    public UpdatedReservation handleRequest(final String reservationId, final ZonedDateTime checkInDate,
        ...
        // calculate the difference between the total cost of the old and new reservation
        // TotalCost is stored as BigDecimal so we have to use BigDecimal .subtract()
        //           and convert the result to a double
        ...
        // Log the difference to ReservationRevenue metric
        //                         metric-name(enum.name)              , value               , metric-unit
