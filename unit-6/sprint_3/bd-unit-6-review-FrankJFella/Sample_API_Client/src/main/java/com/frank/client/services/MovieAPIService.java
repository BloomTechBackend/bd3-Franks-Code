...
public class MovieAPIService {
    ...
    // method was added for caching as the delegate DAO method
    // "automagically" called by cache manger is data is not found in cache
    // it receives the cache key, extract values from it to call the original Dao method
