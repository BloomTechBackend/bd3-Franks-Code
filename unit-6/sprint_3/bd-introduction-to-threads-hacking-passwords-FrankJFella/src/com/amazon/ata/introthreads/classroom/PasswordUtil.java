 ...
 *
 * Process the file containing the passwords we hacked from BookFace
 */
...
//    private static final String HACKED_DATABASE_FILE = "hackedDatabase100x10x190.csv";// Hacked passwords we got from BookFace
//    private static final String COMMON_PASSWORD_FILE = "commonPasswords100.csv";      // Contains common passwords from Internet
