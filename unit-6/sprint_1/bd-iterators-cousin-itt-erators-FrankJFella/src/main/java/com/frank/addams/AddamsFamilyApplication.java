...
public class AddamsFamilyApplication {
        ...
        ********************************************************************************************/
        ...
        /********************************************************************************************
         * Application controller - like the main() for application - it's executed from Java main()
         ********************************************************************************************/
 ...
 *********************************************************************************************************/
        ...
        ********************************************************************************************/
        public String displayMenuAndGetResponse() {
                ...
                // NOTE: Cannot replace a for loop that processes a regular array with Iterators
                //       Iterators may only be used with Collections class objects
                //       Really 'i' is the iterator for the loop - controls access to the current element
        ...
        ********************************************************************************************/
        ...
        public void displayAllPeople() {
                ...
                // for (Person anAddams : theAddamsFamily) {  // replaced by an Iterator
                //  <class-of-objects-in-List>name =    name-of-List.iterator()
                Iterator<Person> allAddamsIterator = theAddamsFamily.iterator();// Instantiate an Iterator for  theAddamsFamily List
                while(allAddamsIterator.hasNext()) {        // Loop through the List using the Iterator while we are not at the end
                Person anAddams = allAddamsIterator.next(); // Retrieve the current element from the List using Iterator
                   personCount++;
        ...
        public void displayByName() {
                ...
                // for(Person anAddams : listOfAddams) {  // replaced with an Iterator
                Iterator<Person> addamsIterator = listOfAddams.iterator();
                while(addamsIterator.hasNext()) {
                        Person anAddams = addamsIterator.next();
        ...
        public void removeAnAddams() {
                ...
                // for (Person anAddams : aListOfAddams) {  //  Replaced bu Iterator to avoid ConcurrentModificationException
                Iterator<Person> cousinItterator = aListOfAddams.iterator();
                while(cousinItterator.hasNext()) {
                        Person anAddams = cousinItterator.next();
                        ...
                        if (deleteResponse.startsWith("Y")) {             // If user wants to delete entry...
                                if (theAddamsFamily.remove(anAddams)) {   //    remove it from the data structure
                                    //aListOfAddams.remove(anAddams);     //       and from the extracted entries - throws exception
                                    cousinItterator.remove();             // Use iterator remove() instead of List remove()
        ...
        private void loadFamilyMembersFromFile() throws FileNotFoundException, DataFileErrorException {
                ...
                try {
                        ...
                        // Note: use of iterator to walk through the file
        ...
        public void displayAllInReverseOrder() {
                //         index  - means start @ 0, so the last element is .size()-1
                //       position - means start @ 1, so the last element is ,size()
                //                                                       .listIterator(starting-element-position
                ListIterator<Person> personListIterator = theAddamsFamily.listIterator(theAddamsFamily.size());
                while(personListIterator.hasPrevious()) {
                        Person aFamilyMember = personListIterator.previous();
                        System.out.println(aFamilyMember);
                }
