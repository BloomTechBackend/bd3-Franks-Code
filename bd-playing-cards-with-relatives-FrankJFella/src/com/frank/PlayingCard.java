...
public class PlayingCard {
	...
	// toString() is used by Java any time it needs to use an object as a String
	//     usually this is done "automagically" by Java - you don't see it or realize it is being used
	//
	// Every class is in Java is a subclass of the Object class.
	//       the Object class has default methods to provide common processing for objects
	//       normally, these default do NOT perform the processing you want done.
	//       so it is recommended you override the Object methods in any class you write
	// toString() is one methods where the Object class methods is not what you want.
